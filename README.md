...
alan is developed against `python`_ version 2.7.
...
* `Read The Docs (.org) <http://alan.readthedocs.org/>`_
* `Python Hosted (.org) <http://pythonhosted.org/alan/>`_
...
at `https://github.com/mearns/alan <https://github.com/mearns/alan/>`_.
...
\ ``alan``\ distribution under the file LICENSE.txt. If you did not
